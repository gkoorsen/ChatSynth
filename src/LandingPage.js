...
const [config, setConfig] = useState({
  ...
  // Purpose taxonomy with user-friendly descriptions
  const tutorPurposes = [
    {
      id: 'scaffolding',
  ...
  // Presets (keeping them as-is for compatibility)
  const presets = [
    {
      id: 'math_basic',
  ...
  // Auto-suggest purposes based on current configuration
  ...
  // Enhanced submit handler with purpose control
                      ...
                      {conversationData.metadata && (
                        <div className="mb-3 p-2 bg-gray-50 rounded text-xs text-gray-600">
                          <div className="grid grid-cols-2 gap-2">
                            ...
                            {/* Show purpose control information */}
